...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional  //LasyInitializationException, happens sometimes
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the inners."
                + "\n" +
                "2 Mash with a fork: Using a fork, roughly mash the avocado. (Don't overdo it! The guacamole should be a little chunky." +
                "\n" +
                "3 Add salt, lime juice, and the rest: Sprinkle with salt and lime (or lemon) juice. The acid in the lime juice will provide some balance to the richnes of the avocado." +
                "Add the chopped onion, cilantro, black pepper, and chiles. Chili peppers vary individually in their hotness. So, start with a half of one chili pepper and add more as necessary." +
                "\n" +
                "4 Cover with plastic and chill to store: Place plastic wrap on the surface of the guacamole, and cover it to prevent air reaching it." +
                "\n\n" +
                "Read more: http://www.simplyrecipes.com/recipes/perfect_guacamole");

        Notes guacNotes = new Notes();
        guacNotes.setRecipeNotes("For a very quick guacamole just take 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
                "Feel free to experiment! One classic Mexican guacamole has pomegranate seeds and chunks of peaches in it.\n" +
                "The simplest version of guacamole is just mashed avocados with salt.  Don't let the availability of other ingredients stop you from making guacamole.\n" +
                "\n\n" +
                "Read more: http://www.simplyrecipes.com/recipes/perfect_guacamole" );
        ...
        guacRecipe.addIngredient(new Ingredient("serraro chiles, stems, and seeds removed, minced", new BigDecimal(2), eachUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("skinless, boneless chicken thighs", new BigDecimal(5), eachUom));
